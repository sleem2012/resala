...
class PaymentState with _$PaymentState {
  ...
  const factory PaymentState.success(PaymentAuthResponse paymentAuthResponse) = PaymentStateSuccess;
  const factory PaymentState.error({required String error}) = PaymentStateError;
  const factory PaymentState.successOrder(OrderResponse orderResponse) = OrderStateSuccess;
  const factory PaymentState.successPaymentKey(PaymentKeyResponse paymentKeyResponse) = PaymentKeySuccess;
